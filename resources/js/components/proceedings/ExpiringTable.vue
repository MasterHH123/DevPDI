    ...
    <div class="table-container">
        ...
        <div class="table-wrapper">
            <table>
                ...
                <tbody>
                <tr
                    v-for="record in expiringProceedingsList"
                    :key="record.id"
...
export default {
    ...
    computed: {
        expiringProceedings(){
            return this.$store.state.expiringProceedings
        },
        expiringProceedingsList(){
            return this.expiringProceedings.list
        },
        pagination(){
            return this.expiringProceedings.pagination
        },
        isLoading(){
            return this.expiringProceedings.loading
        },
        isEmpty(){
            return this.expiringProceedingsList.length < 1
        },
        hasPrev(){
    ...
    methods: {
        ...
        next(){
            if( this.hasNext )
                this.$store.dispatch('getExpiringProceedings', this.pagination.nextPageUrl )
        }
    }
}
</script>
